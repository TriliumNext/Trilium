...
function EditorFeatures() {
    return (
        <OptionsSection title={t("editorfeatures.title")}>
            <EditorFeature name="mathlive-enabled" optionName="mathFieldEnabled" label={t("editorfeatures.mathlive_enabled")} description={t("editorfeatures.mathlive_description")} />
