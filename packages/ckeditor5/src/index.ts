...
export type { CommentsAdapter, CommentsRepository, CommentThreadDataJSON, TemplateDefinition } from "ckeditor5-premium-features";
export { LOCAL_COMMENTS_USER_ID } from "./plugins/comments_integration.js";
