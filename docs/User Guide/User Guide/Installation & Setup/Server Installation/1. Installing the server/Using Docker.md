...
For a complete list of configuration environment variables (network settings, authentication, sync, etc.), see [Configuration (config.ini or environment variables)](https://github.com/TriliumNext/Trilium/blob/main/docs/User%20Guide/User%20Guide/Advanced%20Usage/Configuration%20\(config.ini%20or%20e.md).
