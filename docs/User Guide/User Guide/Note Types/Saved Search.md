...
Saved searches keep the same search options as a live search, including _Expand equivalent notes_ (`#expandEquivalence`). See [Search](../Basic%20Concepts%20and%20Features/Navigation/Search.md).
