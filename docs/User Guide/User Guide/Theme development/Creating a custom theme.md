...
![](Creating%20a%20custom%20theme_5_Creating%20a%20custom%20theme_im.jpg)

## Step 2. Create the theme

|  |  |
| --- | --- |
| ![](Creating%20a%20custom%20theme_3_Creating%20a%20custom%20theme_im.jpg) | Themes are code notes with a special attribute. Start by creating a new code note. |
| ![](Creating%20a%20custom%20theme_1_Creating%20a%20custom%20theme_im.jpg) | Then change the note type to a CSS code. |
| ![](Creating%20a%20custom%20theme_Creating%20a%20custom%20theme_im.jpg) | In the _Owned Attributes_ section define the `#appTheme` attribute to point to any desired name. This is the name that will show up in the appearance section in settings. |
...
![](Creating%20a%20custom%20theme_2_Creating%20a%20custom%20theme_im.jpg)

Afterwards the application will refresh itself with the new theme:

![](Creating%20a%20custom%20theme_4_Creating%20a%20custom%20theme_im.jpg)
