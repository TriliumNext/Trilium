...
- [ ] Test responsive rendering at desktop/mobile widths and long translations. Overflow-safe and narrow-screen CSS is implemented; dialog specs now cover long deck/card labels in responsive structural wrappers, while automated viewport/visual coverage remains.
