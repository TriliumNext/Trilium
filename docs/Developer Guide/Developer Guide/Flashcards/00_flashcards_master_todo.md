...
- [ ] Documentation explains authoring, deck selection, FSRS settings, Anki/JSON data portability, and privacy. Developer TODO docs cover decisions; user-facing guide entry still to write before release.
